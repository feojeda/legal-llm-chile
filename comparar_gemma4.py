...
def main():
    ...
    print("Cargando Gemma 4 entrenado (base + adaptador)...")
    model_trained = PeftModel.from_pretrained(model_base, r"E:\workspace\modelo_gemma4_entrenado")

    resultados = []
    resultados.append("=" * 60)
    resultados.append("COMPARACION: GEMMA 4 BASE vs GEMMA 4 ENTRENADO")
    resultados.append("=" * 60)
    ...
    with open(r"E:\workspace\comparacion_gemma4.txt", "w", encoding="utf-8") as f:
        f.write(output)

    print("\n\nComparacion guardada en: E:\\workspace\\comparacion_gemma4.txt")
